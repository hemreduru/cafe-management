...
return [
    ...
    */
    ...
    'classes_dark_mode_switch' => 'text-warning',
    ...
    */
    ...
    'logout_url' => 'logout',
    'login_url' => 'login',
    'register_url' => null, // Register URL'si iptal edildi
        ...
        'CustomJS' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/js/utilities/swal-handler.js',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '/js/utilities/toast-handler.js',
                ],
            ],
        ],
        'Pace' => [
